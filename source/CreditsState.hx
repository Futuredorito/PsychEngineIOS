...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Psych Engine 5.2h iOS Port'],
			['FutureDorito',		'dorito',				'Main Coder',			 'https://www.youtube.com/@Futuredorito',	    'CFB46B'],
			['UNSTOP4BLE',		    'unstop',		'Bug Fixer',	 'https://www.youtube.com/channel/UCR4wDMrnfOPhW-zZQtNU4iA',	    'CFB46B'],
			['M.A Jigsaw',		    'jigsaw',		'Bug Fixer',	 'https://www.youtube.com/channel/UC2Sk7vtPzOvbVzdVTWrribQ',	    'CFB46B'],
			[''],
			['Psych Engine Team'],
